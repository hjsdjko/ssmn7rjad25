<template>
	<div class="menu-preview">
		...
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0 30px","listStyle":"none","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 0px)","position":"relative","transition":"all 0s ease","justifyContent":"center"}' mode="horizontal" class="el-menu-horizontal-2">
		    <el-menu-item class="home" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#fff","background":"none","display":"none","float":"left","zIndex":"99"}' @click.native="menuHandler('')" index="/">
				<div class="el-tooltip">
					<i :style='{"verticalAlign":"middle","margin":"0 3px 0","color":"inherit","textAlign":"center","background":"none","display":"block","width":"100%","fontSize":"22px","lineHeight":"38px","height":"20px"}' class="icon iconfont icon-shouye-zhihui"></i>
					<span :style='{"verticalAlign":"middle","color":"inherit","textAlign":"center","background":"none","display":"inline-block","width":"100%","fontSize":"16px","lineHeight":"0","height":"16px"}' slot="title">系统首页</span>
				</div>
			</el-menu-item>
		    <el-submenu class="user" popper-class="user" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#333","order":"10"}' index="1">
				<template slot="title">
					<i :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","background":"none","display":"block","width":"100%","fontSize":"22px","lineHeight":"38px","height":"20px"}' class="icon iconfont icon-kuaijiezhifu"></i>
					<span :style='{"verticalAlign":"middle","color":"inherit","textAlign":"center","background":"none","display":"inline-block","width":"100%","fontSize":"16px","lineHeight":"0","height":"16px"}' slot="title">用户信息</span>
				</template>
			...
			<template v-for="(menu,index) in menuList.backMenu">
				<el-submenu v-if="menu.child.length > 1 || !horizontalIsMultiple" class="other" popper-class="other" :popper-append-to-body="false" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#333","background":"none","float":"left"}' :index="index+2+''">
					<template slot="title">
						<i :style='{"verticalAlign":"middle","margin":"0px 3px","color":"inherit","textAlign":"center","background":"none","display":"block","width":"100%","fontSize":"22px","lineHeight":"38px","height":"20px"}' class="el-icon-menu" :class="icons[index]"></i>
						<span :style='{"verticalAlign":"middle","color":"inherit","textAlign":"center","background":"none","display":"inline-block","width":"100%","fontSize":"16px","lineHeight":"0","height":"16px"}' slot="title">{{menu.menu + (horizontalFlag ? '管理' : '')}}</span>
					</template>
				...
				<el-menu-item v-if="menu.child.length <= 1 && horizontalIsMultiple" class="other" popper-class="other" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#333","background":"none","float":"left"}' @click="menuHandler(menu.child[0].tableName)" :index="'/'+menu.child[0].tableName">
				  <div class="el-tooltip">
				    <i :style='{"verticalAlign":"middle","margin":"0px 3px","color":"inherit","textAlign":"center","background":"none","display":"block","width":"100%","fontSize":"22px","lineHeight":"38px","height":"20px"}' class="el-icon-menu" :class="icons[index]"></i>
				    <span :style='{"verticalAlign":"middle","color":"inherit","textAlign":"center","background":"none","display":"inline-block","width":"100%","fontSize":"16px","lineHeight":"0","height":"16px"}' slot="title">{{menu.child[0].menu + (horizontalFlag ? '管理' : '')}}</span>
				  </div>
				</el-menu-item>
			</template>
		</el-menu>
